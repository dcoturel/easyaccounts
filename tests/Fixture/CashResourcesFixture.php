...
/**
 * CashResourcesFixture
 */
class CashResourcesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'usable' => ['type' => 'smallinteger', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'usable' => 1,
                'account_id' => 1,
                'created' => '2019-06-03 17:04:49',
                'modified' => '2019-06-03 17:04:49'
            ],
        ];
        parent::init();
    }
